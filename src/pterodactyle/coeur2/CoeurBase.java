...
public class CoeurBase extends $Coeur implements _ServicesCoeur {
	...
	/**
	 * Constructeur permttant de g�n�rer un coeur en partant de z�ro. Il ne contient alors aucun �changeables, seulement un compte utilisateur
	 * dont les identifiant et cle sont pass�s en param�tres.
	...
	/**
	 * Constructeur permettant de g�n�rer un coeur � partir de sauvegardes pr�c�dentes se trouvant dans le repertoire "sauv".
	 * Ce coeur contiendra tous les utilisateurs, les tags, les echangeables, les fichiers bruts, laiss�s par les coeurs pr�c�dents.
	 * @throws RemoteException
