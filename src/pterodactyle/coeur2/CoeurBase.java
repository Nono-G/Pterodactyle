...
public class CoeurBase extends $Coeur implements _ServicesCoeur {
	...
	/**
	 * Constructeur permttant de gÈnÈrer un coeur en partant de zÈro. Il ne contient alors aucun Èchangeables, seulement un compte utilisateur
	 * dont les identifiant et cle sont passÈs en paramËtres.
	...
	/**
	 * Constructeur permettant de gÈnÈrer un coeur ‡ partir de sauvegardes prÈcÈdentes se trouvant dans le repertoire "sauv".
	 * Ce coeur contiendra tous les utilisateurs, les tags, les echangeables, les fichiers bruts, laissÈs par les coeurs prÈcÈdents.
	 * @throws RemoteException
	...
	public void envoieMessageInterne(String contenu, String objet, String identificateur, String cle,
		...
		//v√©rification identit√© emetteur
		verifIdentite.verificationIdentiteUtilisateur(identificateur, cle, utilisateurs);
		//v√©rification identit√© destinataire
	...
	public void reponseMessage(String url, String contenu, String identificateur, String cle)
			...
			//Pas besoin de v√©rification d'autorisation puisque le messageInterne n'a pas de tag
